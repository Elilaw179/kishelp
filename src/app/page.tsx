    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative w-full h-[60vh] text-white">
        ...
        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-center p-4">
          <h1 className="text-5xl md:text-7xl font-bold animate-in fade-in slide-in-from-bottom-8 duration-700">Welcome to Kourkyls International School</h1>
          <p className="mt-4 text-lg md:text-2xl max-w-3xl animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">Nurturing Great Minds for Excellence Since 2019</p>
          <Link href="/dashboard" className="animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
      ...
      <section className="py-16 bg-card">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12 animate-in fade-in-0 duration-500">Why Choose Us?</h2>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="relative h-80 w-full rounded-lg overflow-hidden shadow-2xl animate-in fade-in slide-in-from-right-8 duration-700">
                    <Image
      ...
      <section className="py-16 bg-accent text-accent-foreground">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4 animate-in fade-in-0 duration-500">Ready to Join Us?</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto animate-in fade-in-0 duration-500 delay-100">
          ...
          <Link href="/contact" className="animate-in fade-in-0 duration-500 delay-200">
